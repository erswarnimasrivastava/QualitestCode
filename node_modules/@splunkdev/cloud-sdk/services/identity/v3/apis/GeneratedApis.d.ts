 ...
 */
import { AddGroupMemberBody, AddGroupRoleBody, AddMemberBody, AddRolePermissionBody, CreateGroupBody, CreatePrincipalBody, CreateRoleBody, CreateSamlClientBody, ECJwk, Group, GroupList, GroupMember, GroupMemberList, GroupRole, GroupRoleList, IdentityProviderBody, IdentityProviderConfigBody, Member, MemberList, PermissionList, Principal, PrincipalList, PrincipalPublicKey, PrincipalPublicKeyStatusBody, ResetPasswordBody, Role, RoleList, RolePermission, RolePermissionList, SamlClient, SetEntitlement, UpdateGroupBody, UpdatePasswordBody, UpdateRoleBody, UpdateSamlClientBody, ValidateInfo } from '../models';
...
export declare class GeneratedIdentityService extends BaseApiService {
     ...
     */
    createIdentityProvider: (identityProviderConfigBody: IdentityProviderConfigBody, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<IdentityProviderBody>;
    /**
     ...
     * @return Principal
     */
    createPrincipal: (createPrincipalBody: CreatePrincipalBody, args?: {
        [key: string]: any;
        inviteID?: string | undefined;
    } | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<Principal>;
    /**
     ...
     * @return SamlClient
     */
    createSamlClient: (createSamlClientBody: CreateSamlClientBody, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<SamlClient>;
    /**
     ...
     * @param requestStatusCallback callback function to listen to the status of a request
     */
    deleteIdentityProvider: (idp: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<object>;
    /**
     ...
     * @param requestStatusCallback callback function to listen to the status of a request
     */
    deleteSamlClient: (samlClient: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<object>;
    /**
     ...
     */
    getEntitlements: (entitlementClientId: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<import("../models").Entitlement[]>;
    /**
     ...
     * @return IdentityProviderBody
     */
    getIdentityProvider: (idp: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<IdentityProviderBody>;
    /**
     ...
     * @return SamlClient
     */
    getSamlClient: (samlClient: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<SamlClient>;
    /**
     ...
     */
    listIdentityProvider: (args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<IdentityProviderBody[]>;
    /**
     ...
     */
    listSamlClients: (args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<string[]>;
    /**
     ...
     * @param requestStatusCallback callback function to listen to the status of a request
     */
    resetPassword: (resetPasswordBody: ResetPasswordBody, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<object>;
    /**
     ...
     * @return EntitlementList
     */
    updateEntitlements: (entitlementClientId: string, setEntitlement: SetEntitlement[], args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<import("../models").Entitlement[]>;
    /**
     ...
     * @return Group
     */
    updateGroup: (group: string, updateGroupBody: UpdateGroupBody, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<Group>;
    /**
     ...
     * @return IdentityProviderBody
     */
    updateIdentityProvider: (idp: string, identityProviderConfigBody: IdentityProviderConfigBody, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<IdentityProviderBody>;
    /**
     ...
     * @param requestStatusCallback callback function to listen to the status of a request
     */
    updatePassword: (principal: string, updatePasswordBody: UpdatePasswordBody, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<object>;
    /**
     ...
     * @return Role
     */
    updateRole: (role: string, updateRoleBody: UpdateRoleBody, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<Role>;
    /**
     ...
     * @return SamlClient
     */
    updateSamlClient: (samlClient: string, updateSamlClientBody: UpdateSamlClientBody, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<SamlClient>;
    /**
