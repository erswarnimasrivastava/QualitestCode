 ...
 */
import { AddGroupMemberBody, AddGroupRoleBody, AddMemberBody, CreateGroupBody, CreatePrincipalBody, CreateRoleBody, ECJwk, Group, GroupMember, GroupRole, IdentityProviderBody, IdentityProviderConfigBody, Member, Principal, PrincipalPublicKey, PrincipalPublicKeyStatusBody, Role, RolePermission, ValidateInfo } from '../models';
...
export declare class GeneratedIdentityService extends BaseApiService {
     ...
     */
    addRolePermission: (role: string, body: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<RolePermission>;
    /**
     ...
     * @return Array<string>
     */
    listGroupMembers: (group: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<string[]>;
    /**
     ...
     * @return Array<string>
     */
    listGroupRoles: (group: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<string[]>;
    /**
     ...
     * @return Array<string>
     */
    listMemberGroups: (member: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<string[]>;
    /**
     ...
     * @return Array<string>
     */
    listMemberRoles: (member: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<string[]>;
    /**
     ...
     * @return Array<string>
     */
    listMembers: (args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<string[]>;
    /**
     ...
     * @return Array<string>
     */
    listPrincipals: (args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<string[]>;
    /**
     ...
     * @return Array<string>
     */
    listRoleGroups: (role: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<string[]>;
    /**
     ...
     * @return Array<string>
     */
    listRolePermissions: (role: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<string[]>;
    /**
     ...
     * @return Array<string>
     */
    listRoles: (args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<string[]>;
    /**
