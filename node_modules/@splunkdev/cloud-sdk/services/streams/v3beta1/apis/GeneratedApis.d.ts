 ...
 */
import { ActivatePipelineRequest, ConnectionPatchRequest, ConnectionPutRequest, ConnectionRequest, ConnectionSaveResponse, DeactivatePipelineRequest, DecompileRequest, DecompileResponse, FilesMetaDataResponse, GetInputSchemaRequest, GetOutputSchemaRequest, LookupTableResponse, MetricsResponse, PaginatedResponseOfConnectionResponse, PaginatedResponseOfConnectorResponse, PaginatedResponseOfPipelineJobStatus, PaginatedResponseOfPipelineResponse, PaginatedResponseOfTemplateResponse, Pipeline, PipelinePatchRequest, PipelineReactivateResponse, PipelineReactivateResponseAsync, PipelineReactivationStatus, PipelineRequest, PipelineResponse, PreviewData, PreviewSessionStartRequest, PreviewStartResponse, PreviewState, ReactivatePipelineRequest, RegistryModel, Response, SplCompileRequest, TemplatePatchRequest, TemplatePutRequest, TemplateRequest, TemplateResponse, UpgradePipelineRequest, UplType, UploadFileResponse, ValidateConnectionRequest, ValidateRequest, ValidateResponse } from '../models';
...
export declare class GeneratedStreamsService extends BaseApiService {
     ...
     * @param requestStatusCallback callback function to listen to the status of a request
     */
    deleteFile: (fileId: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<object>;
    /**
     * Delete lookup file.
     * @param fileId File ID
     * @param args parameters to be sent with the request
     ...
     * @param requestStatusCallback callback function to listen to the status of a request
     */
    deleteSource: (id: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<object>;
    /**
     ...
     */
    getFileMetadata: (fileId: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<UploadFileResponse>;
    /**
     ...
     */
    getFilesMetadata: (args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<FilesMetaDataResponse>;
    /**
     ...
     * @return PipelineResponse
     */
    patchPipeline: (id: string, pipelinePatchRequest: PipelinePatchRequest, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<PipelineResponse>;
    /**
     ...
     */
    reactivationStatus: (id: string, upgradeId: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<PipelineReactivationStatus>;
    /**
     ...
     * @return PipelineResponse
     */
    updatePipeline: (id: string, pipelineRequest: PipelineRequest, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<PipelineResponse>;
    /**
     ...
     */
    upgradePipeline: (id: string, upgradePipelineRequest?: UpgradePipelineRequest | undefined, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<PipelineReactivateResponseAsync>;
    /**
     * Upload new file.
     * @deprecated
     ...
     * @return UploadFileResponse
     */
    uploadFile: (fileName: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<UploadFileResponse>;
    /**
