...
var GeneratedStreamsService = /** @class */ (function (_super) {
    ...
    function GeneratedStreamsService() {
        ...
        _this.deleteFile = function (fileId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_4 || (templateObject_4 = __makeTemplateObject(["/streams/v3beta1/files/", ""], ["/streams/v3beta1/files/", ""])), 'fileId')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.deleteLookupFile = function (fileId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_5 || (templateObject_5 = __makeTemplateObject(["/streams/v3beta1/lookups/files/", ""], ["/streams/v3beta1/lookups/files/", ""])), 'fileId')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.deletePipeline = function (id, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_6 || (templateObject_6 = __makeTemplateObject(["/streams/v3beta1/pipelines/", ""], ["/streams/v3beta1/pipelines/", ""])), 'id')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         ...
         * @param requestStatusCallback callback function to listen to the status of a request
         */
        _this.deleteSource = function (id, args, requestStatusCallback) {
            var path_params = {
                id: id
            };
            var path = _this.template(templateObject_7 || (templateObject_7 = __makeTemplateObject(["/streams/v3beta1/sources/", ""], ["/streams/v3beta1/sources/", ""])), 'id')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getFileMetadata = function (fileId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_9 || (templateObject_9 = __makeTemplateObject(["/streams/v3beta1/files/", ""], ["/streams/v3beta1/files/", ""])), 'fileId')(path_params);
        ...
        _this.getLookupFileMetadata = function (fileId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_10 || (templateObject_10 = __makeTemplateObject(["/streams/v3beta1/lookups/files/", ""], ["/streams/v3beta1/lookups/files/", ""])), 'fileId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getLookupTable = function (connectionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_11 || (templateObject_11 = __makeTemplateObject(["/streams/v3beta1/lookups/", ""], ["/streams/v3beta1/lookups/", ""])), 'connectionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPipeline = function (id, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_12 || (templateObject_12 = __makeTemplateObject(["/streams/v3beta1/pipelines/", ""], ["/streams/v3beta1/pipelines/", ""])), 'id')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPipelineLatestMetrics = function (id, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_13 || (templateObject_13 = __makeTemplateObject(["/streams/v3beta1/pipelines/", "/metrics/latest"], ["/streams/v3beta1/pipelines/", "/metrics/latest"])), 'id')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPreviewData = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_14 || (templateObject_14 = __makeTemplateObject(["/streams/v3beta1/preview-data/", ""], ["/streams/v3beta1/preview-data/", ""])), 'previewSessionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPreviewSession = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_15 || (templateObject_15 = __makeTemplateObject(["/streams/v3beta1/preview-session/", ""], ["/streams/v3beta1/preview-session/", ""])), 'previewSessionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPreviewSessionLatestMetrics = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_16 || (templateObject_16 = __makeTemplateObject(["/streams/v3beta1/preview-session/", "/metrics/latest"], ["/streams/v3beta1/preview-session/", "/metrics/latest"])), 'previewSessionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getTemplate = function (templateId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_17 || (templateObject_17 = __makeTemplateObject(["/streams/v3beta1/templates/", ""], ["/streams/v3beta1/templates/", ""])), 'templateId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.patchPipeline = function (id, pipelinePatchRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_18 || (templateObject_18 = __makeTemplateObject(["/streams/v3beta1/pipelines/", ""], ["/streams/v3beta1/pipelines/", ""])), 'id')(path_params);
        ...
        _this.putConnection = function (connectionId, connectionPutRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_19 || (templateObject_19 = __makeTemplateObject(["/streams/v3beta1/connections/", ""], ["/streams/v3beta1/connections/", ""])), 'connectionId')(path_params);
        ...
        _this.putTemplate = function (templateId, templatePutRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_20 || (templateObject_20 = __makeTemplateObject(["/streams/v3beta1/templates/", ""], ["/streams/v3beta1/templates/", ""])), 'templateId')(path_params);
        ...
        _this.reactivatePipeline = function (id, reactivatePipelineRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_21 || (templateObject_21 = __makeTemplateObject(["/streams/v3beta1/pipelines/", "/reactivate"], ["/streams/v3beta1/pipelines/", "/reactivate"])), 'id')(path_params);
         ...
         */
        _this.reactivationStatus = function (id, upgradeId, args, requestStatusCallback) {
            var path_params = {
                id: id,
                upgradeId: upgradeId
            };
            var path = _this.template(templateObject_22 || (templateObject_22 = __makeTemplateObject(["/streams/v3beta1/pipelines/", "/upgrade/", ""], ["/streams/v3beta1/pipelines/", "/upgrade/", ""])), 'id', 'upgradeId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.updatePipeline = function (id, pipelineRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_25 || (templateObject_25 = __makeTemplateObject(["/streams/v3beta1/pipelines/", ""], ["/streams/v3beta1/pipelines/", ""])), 'id')(path_params);
        ...
        _this.updateTemplate = function (templateId, templatePatchRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_26 || (templateObject_26 = __makeTemplateObject(["/streams/v3beta1/templates/", ""], ["/streams/v3beta1/templates/", ""])), 'templateId')(path_params);
         ...
         */
        _this.upgradePipeline = function (id, upgradePipelineRequest, args, requestStatusCallback) {
            if (!upgradePipelineRequest) {
                throw new client_1.SplunkError({ message: "Bad Request: upgradePipelineRequest is empty or undefined" });
            }
            var path_params = {
                id: id
            };
            var path = _this.template(templateObject_27 || (templateObject_27 = __makeTemplateObject(["/streams/v3beta1/pipelines/", "/upgrade"], ["/streams/v3beta1/pipelines/", "/upgrade"])), 'id')(path_params);
            return _this.client.post(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), upgradePipelineRequest, { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         * Upload new file.
         ...
         * @return UploadFileResponse
         */
        _this.uploadFile = function (fileName, args, requestStatusCallback) {
            var path = "/streams/v3beta1/files";
        ...
        _this.validateConnection = function (validateConnectionRequest, args, requestStatusCallback) {
            var path = "/streams/v3beta1/connections/validate";
