 ...
 *
 * @export
 * @interface PipelineReactivateResponseAsync
 */
export interface PipelineReactivateResponseAsync {
    /**
     *
     * @type {string}
     * @memberof PipelineReactivateResponseAsync
     */
    pipelineId?: string;
    /**
     *
     ...
     * @memberof PipelineReactivateResponseAsync
     */
    requestedAction?: PipelineReactivateResponseAsyncRequestedActionEnum;
}
/**
 * @export
 */
export declare enum PipelineReactivateResponseAsyncRequestedActionEnum {
    ACTIVATE = "ACTIVATE",
