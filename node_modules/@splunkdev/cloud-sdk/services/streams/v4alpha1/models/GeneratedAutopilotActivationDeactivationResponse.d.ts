 ...
 *
 * @export
 * @interface AutopilotActivationDeactivationResponse
 */
export interface AutopilotActivationDeactivationResponse {
    /**
     *
     * @type {string}
     * @memberof AutopilotActivationDeactivationResponse
     */
    message?: string;
}
