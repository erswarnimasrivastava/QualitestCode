...
exports.STREAMS_SERVICE_PREFIX = '/streams/v4alpha1';
...
var GeneratedStreamsService = /** @class */ (function (_super) {
    ...
    function GeneratedStreamsService() {
        ...
        _this.activatePipeline = function (id, activatePipelineRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_1 || (templateObject_1 = __makeTemplateObject(["/streams/v4alpha1/pipelines/", "/activate"], ["/streams/v4alpha1/pipelines/", "/activate"])), 'id')(path_params);
        ...
        _this.compile = function (splCompileRequest, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/pipelines/compile";
        ...
        _this.createConnection = function (connectionRequest, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/connections";
        ...
        _this.createPipeline = function (pipelineRequest, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/pipelines";
        ...
        _this.createTemplate = function (templateRequest, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/templates";
        ...
        _this.deactivatePipeline = function (id, deactivatePipelineRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_2 || (templateObject_2 = __makeTemplateObject(["/streams/v4alpha1/pipelines/", "/deactivate"], ["/streams/v4alpha1/pipelines/", "/deactivate"])), 'id')(path_params);
        ...
        _this.decompile = function (decompileRequest, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/pipelines/decompile";
        ...
        _this.deleteConnection = function (connectionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_3 || (templateObject_3 = __makeTemplateObject(["/streams/v4alpha1/connections/", ""], ["/streams/v4alpha1/connections/", ""])), 'connectionId')(path_params);
        ...
        _this.deleteLookupFile = function (fileId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_4 || (templateObject_4 = __makeTemplateObject(["/streams/v4alpha1/lookups/files/", ""], ["/streams/v4alpha1/lookups/files/", ""])), 'fileId')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.deletePipeline = function (id, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_5 || (templateObject_5 = __makeTemplateObject(["/streams/v4alpha1/pipelines/", ""], ["/streams/v4alpha1/pipelines/", ""])), 'id')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.deleteTemplate = function (templateId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_6 || (templateObject_6 = __makeTemplateObject(["/streams/v4alpha1/templates/", ""], ["/streams/v4alpha1/templates/", ""])), 'templateId')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getInputSchema = function (getInputSchemaRequest, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/pipelines/input-schema";
        ...
        _this.getLookupFileMetadata = function (fileId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_7 || (templateObject_7 = __makeTemplateObject(["/streams/v4alpha1/lookups/files/", ""], ["/streams/v4alpha1/lookups/files/", ""])), 'fileId')(path_params);
        ...
        _this.getLookupFilesMetadata = function (args, requestStatusCallback) {
            var path = "/streams/v4alpha1/lookups/files";
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getLookupTable = function (connectionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_8 || (templateObject_8 = __makeTemplateObject(["/streams/v4alpha1/lookups/", ""], ["/streams/v4alpha1/lookups/", ""])), 'connectionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getOutputSchema = function (getOutputSchemaRequest, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/pipelines/output-schema";
        ...
        _this.getPipeline = function (id, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_9 || (templateObject_9 = __makeTemplateObject(["/streams/v4alpha1/pipelines/", ""], ["/streams/v4alpha1/pipelines/", ""])), 'id')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPipelineLatestMetrics = function (id, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_10 || (templateObject_10 = __makeTemplateObject(["/streams/v4alpha1/pipelines/", "/metrics/latest"], ["/streams/v4alpha1/pipelines/", "/metrics/latest"])), 'id')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPreviewData = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_11 || (templateObject_11 = __makeTemplateObject(["/streams/v4alpha1/preview-data/", ""], ["/streams/v4alpha1/preview-data/", ""])), 'previewSessionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPreviewSession = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_12 || (templateObject_12 = __makeTemplateObject(["/streams/v4alpha1/preview-session/", ""], ["/streams/v4alpha1/preview-session/", ""])), 'previewSessionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPreviewSessionLatestMetrics = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_13 || (templateObject_13 = __makeTemplateObject(["/streams/v4alpha1/preview-session/", "/metrics/latest"], ["/streams/v4alpha1/preview-session/", "/metrics/latest"])), 'previewSessionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getRegistry = function (args, requestStatusCallback) {
            var path = "/streams/v4alpha1/pipelines/registry";
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getTemplate = function (templateId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_14 || (templateObject_14 = __makeTemplateObject(["/streams/v4alpha1/templates/", ""], ["/streams/v4alpha1/templates/", ""])), 'templateId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listConnectors = function (args, requestStatusCallback) {
            var path = "/streams/v4alpha1/connectors";
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.patchPipeline = function (id, pipelinePatchRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_15 || (templateObject_15 = __makeTemplateObject(["/streams/v4alpha1/pipelines/", ""], ["/streams/v4alpha1/pipelines/", ""])), 'id')(path_params);
        ...
        _this.putConnection = function (connectionId, connectionPutRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_16 || (templateObject_16 = __makeTemplateObject(["/streams/v4alpha1/connections/", ""], ["/streams/v4alpha1/connections/", ""])), 'connectionId')(path_params);
        ...
        _this.putTemplate = function (templateId, templatePutRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_17 || (templateObject_17 = __makeTemplateObject(["/streams/v4alpha1/templates/", ""], ["/streams/v4alpha1/templates/", ""])), 'templateId')(path_params);
        ...
        _this.startPreview = function (previewSessionStartRequest, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/preview-session";
        ...
        _this.stopPreview = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_18 || (templateObject_18 = __makeTemplateObject(["/streams/v4alpha1/preview-session/", ""], ["/streams/v4alpha1/preview-session/", ""])), 'previewSessionId')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.updateConnection = function (connectionId, connectionPatchRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_19 || (templateObject_19 = __makeTemplateObject(["/streams/v4alpha1/connections/", ""], ["/streams/v4alpha1/connections/", ""])), 'connectionId')(path_params);
        ...
        _this.updatePipeline = function (id, pipelineRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_20 || (templateObject_20 = __makeTemplateObject(["/streams/v4alpha1/pipelines/", ""], ["/streams/v4alpha1/pipelines/", ""])), 'id')(path_params);
        ...
        _this.updateTemplate = function (templateId, templatePatchRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_21 || (templateObject_21 = __makeTemplateObject(["/streams/v4alpha1/templates/", ""], ["/streams/v4alpha1/templates/", ""])), 'templateId')(path_params);
         ...
         * @return UploadFileResponse
         */
        _this.uploadLookupFile = function (fileName, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/lookups/files";
            var formData = new form_data_1["default"]();
            var readStream = fs_1.createReadStream(fileName);
            formData.append("file", readStream);
            var formHeaders = formData.getHeaders();
            return _this.client.post(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), formData, { query: args, headers: formHeaders, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         ...
         * @param requestStatusCallback callback function to listen to the status of a request
         */
        _this.validateConnection = function (validateConnectionRequest, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/connections/validate";
            return _this.client.post(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), validateConnectionRequest, { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.validatePipeline = function (validateRequest, args, requestStatusCallback) {
            var path = "/streams/v4alpha1/pipelines/validate";
