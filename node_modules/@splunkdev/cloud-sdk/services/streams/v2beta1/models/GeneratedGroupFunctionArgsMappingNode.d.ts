 ...
 */
import { GroupFunctionArgsNode } from './';
/**
 *
 * @export
 * @interface GroupFunctionArgsMappingNode
 */
export interface GroupFunctionArgsMappingNode {
    /**
     * List of mappings from group function argument to function argument.
     * @type {Array<GroupFunctionArgsNode>}
     * @memberof GroupFunctionArgsMappingNode
     */
    arguments: Array<GroupFunctionArgsNode>;
    /**
