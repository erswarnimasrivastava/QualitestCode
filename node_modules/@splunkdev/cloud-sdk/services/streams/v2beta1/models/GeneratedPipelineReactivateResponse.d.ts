 ...
 *
 * @export
 * @interface PipelineReactivateResponse
 */
export interface PipelineReactivateResponse {
    /**
     *
     * @type {number}
     * @memberof PipelineReactivateResponse
     */
    currentlyActiveVersion?: number;
    /**
     *
     * @type {string}
     * @memberof PipelineReactivateResponse
 ...
 * @export
 */
export declare enum PipelineReactivateResponsePipelineReactivationStatusEnum {
    Activated = "activated",
