...
exports.STREAMS_SERVICE_PREFIX = '/streams/v2beta1';
...
var GeneratedStreamsService = /** @class */ (function (_super) {
    ...
    function GeneratedStreamsService() {
        ...
        _this.activatePipeline = function (id, activatePipelineRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_1 || (templateObject_1 = __makeTemplateObject(["/streams/v2beta1/pipelines/", "/activate"], ["/streams/v2beta1/pipelines/", "/activate"])), 'id')(path_params);
         ...
         * @return UplPipeline
         */
        _this.compileDSL = function (dslCompilationRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/pipelines/compile-dsl";
            return _this.client.post(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), dslCompilationRequest, { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         ...
         * @return UplPipeline
         */
        _this.compileSPL = function (splCompileRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/pipelines/compile-spl";
        ...
        _this.createConnection = function (connectionRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/connections";
         ...
         */
        _this.createGroup = function (groupRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/groups";
            return _this.client.post(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), groupRequest, { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         * Creates a pipeline.
        ...
        _this.createPipeline = function (pipelineRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/pipelines";
        ...
        _this.createTemplate = function (templateRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/templates";
        ...
        _this.deactivatePipeline = function (id, deactivatePipelineRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_2 || (templateObject_2 = __makeTemplateObject(["/streams/v2beta1/pipelines/", "/deactivate"], ["/streams/v2beta1/pipelines/", "/deactivate"])), 'id')(path_params);
        ...
        _this.deleteConnection = function (connectionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_3 || (templateObject_3 = __makeTemplateObject(["/streams/v2beta1/connections/", ""], ["/streams/v2beta1/connections/", ""])), 'connectionId')(path_params);
         ...
         * @param requestStatusCallback callback function to listen to the status of a request
         */
        _this.deleteGroup = function (groupId, args, requestStatusCallback) {
            var path_params = {
                groupId: groupId
            };
            var path = _this.template(templateObject_4 || (templateObject_4 = __makeTemplateObject(["/streams/v2beta1/groups/", ""], ["/streams/v2beta1/groups/", ""])), 'groupId')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.deletePipeline = function (id, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_5 || (templateObject_5 = __makeTemplateObject(["/streams/v2beta1/pipelines/", ""], ["/streams/v2beta1/pipelines/", ""])), 'id')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.deleteTemplate = function (templateId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_6 || (templateObject_6 = __makeTemplateObject(["/streams/v2beta1/templates/", ""], ["/streams/v2beta1/templates/", ""])), 'templateId')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         ...
         * @return UplPipeline
         */
        _this.expandGroup = function (groupId, groupExpandRequest, args, requestStatusCallback) {
            var path_params = {
                groupId: groupId
            };
            var path = _this.template(templateObject_7 || (templateObject_7 = __makeTemplateObject(["/streams/v2beta1/groups/", "/expand"], ["/streams/v2beta1/groups/", "/expand"])), 'groupId')(path_params);
            return _this.client.post(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), groupExpandRequest, { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         ...
         * @return UplPipeline
         */
        _this.expandPipeline = function (uplPipeline, args, requestStatusCallback) {
            var path = "/streams/v2beta1/pipelines/expand";
            return _this.client.post(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), uplPipeline, { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         ...
         * @return GroupResponse
         */
        _this.getGroup = function (groupId, args, requestStatusCallback) {
            var path_params = {
                groupId: groupId
            };
            var path = _this.template(templateObject_8 || (templateObject_8 = __makeTemplateObject(["/streams/v2beta1/groups/", ""], ["/streams/v2beta1/groups/", ""])), 'groupId')(path_params);
        ...
        _this.getInputSchema = function (getInputSchemaRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/pipelines/input-schema";
        ...
        _this.getOutputSchema = function (getOutputSchemaRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/pipelines/output-schema";
        ...
        _this.getPipeline = function (id, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_9 || (templateObject_9 = __makeTemplateObject(["/streams/v2beta1/pipelines/", ""], ["/streams/v2beta1/pipelines/", ""])), 'id')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPipelineLatestMetrics = function (id, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_10 || (templateObject_10 = __makeTemplateObject(["/streams/v2beta1/pipelines/", "/metrics/latest"], ["/streams/v2beta1/pipelines/", "/metrics/latest"])), 'id')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPipelinesStatus = function (args, requestStatusCallback) {
            var path = "/streams/v2beta1/pipelines/status";
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPreviewData = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_11 || (templateObject_11 = __makeTemplateObject(["/streams/v2beta1/preview-data/", ""], ["/streams/v2beta1/preview-data/", ""])), 'previewSessionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPreviewSession = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_12 || (templateObject_12 = __makeTemplateObject(["/streams/v2beta1/preview-session/", ""], ["/streams/v2beta1/preview-session/", ""])), 'previewSessionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPreviewSessionLatestMetrics = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_13 || (templateObject_13 = __makeTemplateObject(["/streams/v2beta1/preview-session/", "/metrics/latest"], ["/streams/v2beta1/preview-session/", "/metrics/latest"])), 'previewSessionId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getRegistry = function (args, requestStatusCallback) {
            var path = "/streams/v2beta1/pipelines/registry";
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getTemplate = function (templateId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_14 || (templateObject_14 = __makeTemplateObject(["/streams/v2beta1/templates/", ""], ["/streams/v2beta1/templates/", ""])), 'templateId')(path_params);
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listConnectors = function (args, requestStatusCallback) {
            var path = "/streams/v2beta1/connectors";
            return _this.client.get(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         ...
         * @return UplPipeline
         */
        _this.mergePipelines = function (pipelinesMergeRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/pipelines/merge";
            return _this.client.post(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), pipelinesMergeRequest, { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.putConnection = function (connectionId, connectionPutRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_15 || (templateObject_15 = __makeTemplateObject(["/streams/v2beta1/connections/", ""], ["/streams/v2beta1/connections/", ""])), 'connectionId')(path_params);
         ...
         * @return GroupResponse
         */
        _this.putGroup = function (groupId, groupPutRequest, args, requestStatusCallback) {
            var path_params = {
                groupId: groupId
            };
            var path = _this.template(templateObject_16 || (templateObject_16 = __makeTemplateObject(["/streams/v2beta1/groups/", ""], ["/streams/v2beta1/groups/", ""])), 'groupId')(path_params);
            return _this.client.put(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), groupPutRequest, { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.putTemplate = function (templateId, templatePutRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_17 || (templateObject_17 = __makeTemplateObject(["/streams/v2beta1/templates/", ""], ["/streams/v2beta1/templates/", ""])), 'templateId')(path_params);
        ...
        _this.reactivatePipeline = function (id, reactivatePipelineRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_18 || (templateObject_18 = __makeTemplateObject(["/streams/v2beta1/pipelines/", "/reactivate"], ["/streams/v2beta1/pipelines/", "/reactivate"])), 'id')(path_params);
        ...
        _this.startPreview = function (previewSessionStartRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/preview-session";
        ...
        _this.stopPreview = function (previewSessionId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_19 || (templateObject_19 = __makeTemplateObject(["/streams/v2beta1/preview-session/", ""], ["/streams/v2beta1/preview-session/", ""])), 'previewSessionId')(path_params);
            return _this.client["delete"](exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.updateConnection = function (connectionId, connectionPatchRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_20 || (templateObject_20 = __makeTemplateObject(["/streams/v2beta1/connections/", ""], ["/streams/v2beta1/connections/", ""])), 'connectionId')(path_params);
         ...
         * @return GroupResponse
         */
        _this.updateGroup = function (groupId, groupPatchRequest, args, requestStatusCallback) {
            var path_params = {
                groupId: groupId
            };
            var path = _this.template(templateObject_21 || (templateObject_21 = __makeTemplateObject(["/streams/v2beta1/groups/", ""], ["/streams/v2beta1/groups/", ""])), 'groupId')(path_params);
            return _this.client.patch(exports.STREAMS_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), groupPatchRequest, { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         ...
         * @return PipelineResponse
         */
        _this.updatePipeline = function (id, pipelinePatchRequest, args, requestStatusCallback) {
            var path_params = {
                id: id
            };
            var path = _this.template(templateObject_22 || (templateObject_22 = __makeTemplateObject(["/streams/v2beta1/pipelines/", ""], ["/streams/v2beta1/pipelines/", ""])), 'id')(path_params);
        ...
        _this.updateTemplate = function (templateId, templatePatchRequest, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_23 || (templateObject_23 = __makeTemplateObject(["/streams/v2beta1/templates/", ""], ["/streams/v2beta1/templates/", ""])), 'templateId')(path_params);
        ...
        _this.validatePipeline = function (validateRequest, args, requestStatusCallback) {
            var path = "/streams/v2beta1/pipelines/validate";
