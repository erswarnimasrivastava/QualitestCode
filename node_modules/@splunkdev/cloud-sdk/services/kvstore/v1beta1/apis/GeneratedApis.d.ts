 ...
 */
import { IndexDefinition, IndexDescription, PingResponse, Record } from '../models';
...
export declare class GeneratedKVStoreService extends BaseApiService {
    ...
    insertRecord: (collection: string, body: {
        [key: string]: any;
    }, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<Record>;
    /**
