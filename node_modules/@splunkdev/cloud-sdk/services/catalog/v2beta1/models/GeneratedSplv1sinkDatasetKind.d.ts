 ...
 * @export
 */
export declare enum Splv1sinkDatasetKind {
    Splv1sink = "splv1sink"
}
export declare function Splv1sinkDatasetKindFromJSON(json: any): Splv1sinkDatasetKind;
export declare function Splv1sinkDatasetKindToJSON(value?: Splv1sinkDatasetKind): any;
