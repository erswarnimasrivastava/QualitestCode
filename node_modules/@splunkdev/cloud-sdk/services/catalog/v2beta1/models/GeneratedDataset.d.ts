 ...
 */
import { FederatedDataset, ImportDataset, IndexDataset, KVCollectionDataset, LookupDataset, MetricDataset, ViewDataset } from './';
/**
 * @type Dataset
 * A complete dataset as rendered in POST, PATCH responses.
 * @export
 */
export declare type Dataset = FederatedDataset | ImportDataset | IndexDataset | KVCollectionDataset | LookupDataset | MetricDataset | ViewDataset;
