 ...
 * @export
 */
export declare enum LookupDatasetExternalKind {
    Kvcollection = "kvcollection"
}
export declare function LookupDatasetExternalKindFromJSON(json: any): LookupDatasetExternalKind;
export declare function LookupDatasetExternalKindToJSON(value?: LookupDatasetExternalKind): any;
