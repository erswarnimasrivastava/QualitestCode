 ...
 * @export
 */
export declare enum EvalActionKind {
    EVAL = "EVAL"
}
export declare function EvalActionKindFromJSON(json: any): EvalActionKind;
export declare function EvalActionKindToJSON(value?: EvalActionKind): any;
