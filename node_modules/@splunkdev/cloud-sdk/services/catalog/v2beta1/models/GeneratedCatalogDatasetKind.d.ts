 ...
 * @export
 */
export declare enum CatalogDatasetKind {
    Catalog = "catalog"
}
export declare function CatalogDatasetKindFromJSON(json: any): CatalogDatasetKind;
export declare function CatalogDatasetKindToJSON(value?: CatalogDatasetKind): any;
