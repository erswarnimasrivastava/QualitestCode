 ...
 * @export
 */
export declare enum JobDatasetKind {
    Job = "job"
}
export declare function JobDatasetKindFromJSON(json: any): JobDatasetKind;
export declare function JobDatasetKindToJSON(value?: JobDatasetKind): any;
