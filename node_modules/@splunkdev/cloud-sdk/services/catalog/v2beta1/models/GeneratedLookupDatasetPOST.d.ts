 ...
 */
import { FieldPOST, LookupDatasetExternalKind, LookupDatasetKind } from './';
/**
 * Initial property values for creating a new lookup dataset using a POST request.
 * @export
 * @interface LookupDatasetPOST
 */
export interface LookupDatasetPOST {
    /**
     *
     * @type {LookupDatasetExternalKind}
     * @memberof LookupDatasetPOST
     */
