 ...
 * @export
 */
export declare enum ImportDatasetKind {
    Import = "import"
}
export declare function ImportDatasetKindFromJSON(json: any): ImportDatasetKind;
export declare function ImportDatasetKindToJSON(value?: ImportDatasetKind): any;
