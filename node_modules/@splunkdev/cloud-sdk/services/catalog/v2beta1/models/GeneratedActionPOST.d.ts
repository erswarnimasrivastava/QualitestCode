 ...
 */
import { AliasActionPOST, AutoKVActionPOST, EvalActionPOST, LookupActionPOST, RegexActionPOST } from './';
/**
 * @type ActionPOST
 * Initial property values for creating a new action using a POST request.
 * @export
 */
export declare type ActionPOST = AliasActionPOST | AutoKVActionPOST | EvalActionPOST | LookupActionPOST | RegexActionPOST;
