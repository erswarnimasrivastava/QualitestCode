 ...
 * @export
 */
export declare enum RelationshipFieldKind {
    EXACT = "EXACT",
    LATESTBEFORE = "LATEST_BEFORE"
}
export declare function RelationshipFieldKindFromJSON(json: any): RelationshipFieldKind;
export declare function RelationshipFieldKindToJSON(value?: RelationshipFieldKind): any;
