 ...
 * @export
 * @interface ImportDatasetByNameProperties
 */
export interface ImportDatasetByNameProperties {
    /**
     *
     * @type {ImportDatasetKind}
     * @memberof ImportDatasetByNameProperties
     */
