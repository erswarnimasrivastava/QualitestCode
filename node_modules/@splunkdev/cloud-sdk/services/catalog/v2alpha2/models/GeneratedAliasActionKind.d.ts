 ...
 * @export
 */
export declare enum AliasActionKind {
    ALIAS = "ALIAS"
}
export declare function AliasActionKindFromJSON(json: any): AliasActionKind;
export declare function AliasActionKindToJSON(value?: AliasActionKind): any;
