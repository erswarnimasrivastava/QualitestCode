 ...
 * @export
 * @interface LookupActionProperties
 */
export interface LookupActionProperties {
    /**
     * The lookup body.
     * @type {string}
     * @memberof LookupActionProperties
     */
    expression?: string;
    /**
     *
