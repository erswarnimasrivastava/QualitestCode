 ...
 */
import { DeleteJobsResponse, ExecutionPatch, Job, JobPatch, JobsPatch, ListJobsResponse, PatchJobsResponse, SingleExecutionResponse, SingleJobResponse } from '../models';
import BaseApiService from "../../../../baseapiservice";
import { CollectServiceExtensions } from "../../../../service_extensions/collect";
import { RequestStatus } from '../../../../client';
export declare const COLLECT_SERVICE_PREFIX: string;
export declare const COLLECT_SERVICE_CLUSTER: string;
/**
 * Collect Service
 * Version: v1beta1.8
 * With the Collect service in Splunk Cloud Services, you can manage how data collection jobs ingest event and metric data.
 */
export declare class GeneratedCollectService extends BaseApiService {
     ...
     */
    createExecution: (jobId: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<SingleExecutionResponse>;
    /**
     ...
     */
    createJob: (job: Job, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<SingleJobResponse>;
    /**
     ...
     * @param requestStatusCallback callback function to listen to the status of a request
     */
    deleteJob: (jobId: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<object>;
    /**
     ...
     */
    deleteJobs: (args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<DeleteJobsResponse>;
    /**
     ...
     * @return SingleExecutionResponse
     */
    getExecution: (jobId: string, executionUid: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<SingleExecutionResponse>;
    /**
     ...
     * @return SingleJobResponse
     */
    getJob: (jobId: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<SingleJobResponse>;
    /**
    ...
    } | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<ListJobsResponse>;
    /**
     ...
     * @param requestStatusCallback callback function to listen to the status of a request
     */
    patchExecution: (jobId: string, executionUid: string, executionPatch: ExecutionPatch, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<object>;
    /**
     * This API returns `403` if the number of collect workers is over a certain limit.
     ...
     * @return SingleJobResponse
     */
    patchJob: (jobId: string, jobPatch: JobPatch, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<SingleJobResponse>;
    /**
     ...
     */
    patchJobs: (jobsPatch: JobsPatch, args?: {
        [key: string]: any;
        connectorID?: string | undefined;
        jobIDs?: string[] | undefined;
    } | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<PatchJobsResponse>;
}
export declare type CollectService = GeneratedCollectService & CollectServiceExtensions;
export declare const CollectService: typeof GeneratedCollectService;
