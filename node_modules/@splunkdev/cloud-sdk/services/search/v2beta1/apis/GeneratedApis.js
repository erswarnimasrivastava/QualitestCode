...
var GeneratedSearchService = /** @class */ (function (_super) {
    ...
    function GeneratedSearchService() {
        ...
        _this.exportResults = function (sid, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_1 || (templateObject_1 = __makeTemplateObject(["/search/v2beta1/jobs/", "/export"], ["/search/v2beta1/jobs/", "/export"])), 'sid')(path_params);
        ...
        _this.getJob = function (sid, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_2 || (templateObject_2 = __makeTemplateObject(["/search/v2beta1/jobs/", ""], ["/search/v2beta1/jobs/", ""])), 'sid')(path_params);
            return _this.client.get(exports.SEARCH_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listEventsSummary = function (sid, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_3 || (templateObject_3 = __makeTemplateObject(["/search/v2beta1/jobs/", "/timeline-metadata/auto/events-summary"], ["/search/v2beta1/jobs/", "/timeline-metadata/auto/events-summary"])), 'sid')(path_params);
            return _this.client.get(exports.SEARCH_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listFieldsSummary = function (sid, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_4 || (templateObject_4 = __makeTemplateObject(["/search/v2beta1/jobs/", "/timeline-metadata/auto/fields-summary"], ["/search/v2beta1/jobs/", "/timeline-metadata/auto/fields-summary"])), 'sid')(path_params);
            return _this.client.get(exports.SEARCH_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listPreviewResults = function (sid, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_5 || (templateObject_5 = __makeTemplateObject(["/search/v2beta1/jobs/", "/results-preview"], ["/search/v2beta1/jobs/", "/results-preview"])), 'sid')(path_params);
            return _this.client.get(exports.SEARCH_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listResults = function (sid, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_6 || (templateObject_6 = __makeTemplateObject(["/search/v2beta1/jobs/", "/results"], ["/search/v2beta1/jobs/", "/results"])), 'sid')(path_params);
            return _this.client.get(exports.SEARCH_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listTimeBuckets = function (sid, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_7 || (templateObject_7 = __makeTemplateObject(["/search/v2beta1/jobs/", "/timeline-metadata/auto/time-buckets"], ["/search/v2beta1/jobs/", "/timeline-metadata/auto/time-buckets"])), 'sid')(path_params);
            return _this.client.get(exports.SEARCH_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.updateJob = function (sid, updateJob, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_8 || (templateObject_8 = __makeTemplateObject(["/search/v2beta1/jobs/", ""], ["/search/v2beta1/jobs/", ""])), 'sid')(path_params);
