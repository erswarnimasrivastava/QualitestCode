 ...
 * @export
 */
export declare enum IndexDatasetKind {
    Index = "index"
}
export declare function IndexDatasetKindFromJSON(json: any): IndexDatasetKind;
export declare function IndexDatasetKindToJSON(value?: IndexDatasetKind): any;
