 ...
 * @export
 */
export declare enum LookupDatasetKind {
    Lookup = "lookup"
}
export declare function LookupDatasetKindFromJSON(json: any): LookupDatasetKind;
export declare function LookupDatasetKindToJSON(value?: LookupDatasetKind): any;
