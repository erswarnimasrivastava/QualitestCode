 ...
 */
import { FederatedDataset, IndexDataset, KVCollectionDataset, LookupDataset, MetricDataset } from './';
/**
 * @type Dataset
 * A complete dataset as rendered in POST, PATCH responses.
 * @export
 */
export declare type Dataset = FederatedDataset | IndexDataset | KVCollectionDataset | LookupDataset | MetricDataset;
