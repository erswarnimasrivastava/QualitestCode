 ...
 * @export
 */
export declare enum MetricDatasetKind {
    Metric = "metric"
}
export declare function MetricDatasetKindFromJSON(json: any): MetricDatasetKind;
export declare function MetricDatasetKindToJSON(value?: MetricDatasetKind): any;
