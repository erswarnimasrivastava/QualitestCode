 ...
 * @export
 */
export declare enum FederatedDatasetKind {
    Federated = "federated"
}
export declare function FederatedDatasetKindFromJSON(json: any): FederatedDatasetKind;
export declare function FederatedDatasetKindToJSON(value?: FederatedDatasetKind): any;
