 ...
 */
import { FederatedDatasetPATCH, IndexDatasetPATCH, KVCollectionDatasetPATCH, LookupDatasetPATCH, MetricDatasetPATCH } from './';
/**
 * @type DatasetPATCH
 * Property values to be set in an existing dataset using a PATCH request.
 * @export
 */
export declare type DatasetPATCH = FederatedDatasetPATCH | IndexDatasetPATCH | KVCollectionDatasetPATCH | LookupDatasetPATCH | MetricDatasetPATCH;
