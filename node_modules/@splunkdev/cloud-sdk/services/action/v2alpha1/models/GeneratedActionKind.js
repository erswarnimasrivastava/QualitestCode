...
(function (ActionKind) {
    ...
    ActionKind["AppMessage"] = "app-message";
})(ActionKind = exports.ActionKind || (exports.ActionKind = {}));
function ActionKindFromJSON(json) {
    return json;
}
exports.ActionKindFromJSON = ActionKindFromJSON;
function ActionKindToJSON(value) {
    return value;
}
exports.ActionKindToJSON = ActionKindToJSON;
//# sourceMappingURL=GeneratedActionKind.js.map