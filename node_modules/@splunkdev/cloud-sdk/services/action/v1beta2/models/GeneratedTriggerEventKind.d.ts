 ...
 * @export
 */
export declare enum TriggerEventKind {
    Trigger = "trigger"
}
export declare function TriggerEventKindFromJSON(json: any): TriggerEventKind;
export declare function TriggerEventKindToJSON(value?: TriggerEventKind): any;
