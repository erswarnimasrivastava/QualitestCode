 ...
 */
import { Action, ActionMutable, ActionResult, ActionResultEmailDetail, PublicWebhookKey, TriggerEvent } from '../models';
...
export declare class GeneratedActionService extends BaseApiService {
     ...
     * @return ActionResult
     */
    getActionStatus: (actionName: string, statusId: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<ActionResult>;
    /**
     ...
     */
    getActionStatusDetails: (actionName: string, statusId: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<ActionResultEmailDetail[]>;
    /**
     ...
     * @param requestStatusCallback callback function to listen to the status of a request
     */
    triggerAction: (actionName: string, triggerEvent: TriggerEvent, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<object>;
    /**
