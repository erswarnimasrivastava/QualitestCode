...
exports.ACTION_SERVICE_PREFIX = '/action/v1beta2';
...
var GeneratedActionService = /** @class */ (function (_super) {
    ...
    function GeneratedActionService() {
        ...
        _this.createAction = function (action, args, requestStatusCallback) {
            var path = "/action/v1beta2/actions";
        ...
        _this.deleteAction = function (actionName, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_1 || (templateObject_1 = __makeTemplateObject(["/action/v1beta2/actions/", ""], ["/action/v1beta2/actions/", ""])), 'action_name')(path_params);
        ...
        _this.getAction = function (actionName, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_2 || (templateObject_2 = __makeTemplateObject(["/action/v1beta2/actions/", ""], ["/action/v1beta2/actions/", ""])), 'action_name')(path_params);
         ...
         * @return ActionResult
         */
        _this.getActionStatus = function (actionName, statusId, args, requestStatusCallback) {
            var path_params = {
                action_name: actionName,
                status_id: statusId
            };
            var path = _this.template(templateObject_3 || (templateObject_3 = __makeTemplateObject(["/action/v1beta2/actions/", "/status/", ""], ["/action/v1beta2/actions/", "/status/", ""])), 'action_name', 'status_id')(path_params);
            return _this.client.get(exports.ACTION_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         ...
         */
        _this.getActionStatusDetails = function (actionName, statusId, args, requestStatusCallback) {
            var path_params = {
                action_name: actionName,
                status_id: statusId
            };
            var path = _this.template(templateObject_4 || (templateObject_4 = __makeTemplateObject(["/action/v1beta2/actions/", "/status/", "/details"], ["/action/v1beta2/actions/", "/status/", "/details"])), 'action_name', 'status_id')(path_params);
            return _this.client.get(exports.ACTION_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPublicWebhookKeys = function (args, requestStatusCallback) {
            var path = "/system/action/v1beta2/webhook/keys";
            return _this.client.get(exports.ACTION_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
         ...
         * @param requestStatusCallback callback function to listen to the status of a request
         */
        _this.triggerAction = function (actionName, triggerEvent, args, requestStatusCallback) {
            var path_params = {
                action_name: actionName
            };
            var path = _this.template(templateObject_5 || (templateObject_5 = __makeTemplateObject(["/action/v1beta2/actions/", ""], ["/action/v1beta2/actions/", ""])), 'action_name')(path_params);
            return _this.client.post(exports.ACTION_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), triggerEvent, { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.updateAction = function (actionName, actionMutable, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_6 || (templateObject_6 = __makeTemplateObject(["/action/v1beta2/actions/", ""], ["/action/v1beta2/actions/", ""])), 'action_name')(path_params);
