 ...
 */
var Hostname = /** @class */ (function () {
    function Hostname(domain, region, scheme, port) {
    ...
    Hostname.prototype.getHostname = function (path, tenant) {
...
var ServiceClient = /** @class */ (function () {
    ...
    function ServiceClient(args) {
        ...
        this.buildUrl = function (cluster, path, query) {
            var hostname = _this.hostname !== null ? _this.hostname.getHostname(path, _this.tenant) : _this.urls[cluster] || exports.DEFAULT_URLS.api;
            var basePath = "" + hostname + escape(path);
        ...
        this.fetch = function (method, cluster, path, opts, data) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var url, queue, headers, type, contentTypeForm, options, request, requestStatusCallback;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
